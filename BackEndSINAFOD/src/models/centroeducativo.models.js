...
export const postCentroEducativoParticipanteM = async (idcentroeducativo, idparticipante, cargo, jornada, modalidad, prebasica, basica, media, primero, segundo, tercero, cuarto, quinto, sexto, septimo, octavo, noveno, decimo, onceavo, doceavo) => {
    try {
        const { rows } = await pool.query(`
...
export const putCentroEducativoParticipanteM = async (idcentroeducativo, idparticipante, cargo, jornada, modalidad, prebasica, basica, media, primero, segundo, tercero, cuarto, quinto, sexto, septimo, octavo, noveno, decimo, onceavo, doceavo, id) => {
    try {
        const { rows } = await pool.query(`
                ...
                WHERE id = $21
                RETURNING *`,
            [idcentroeducativo, idparticipante, cargo, jornada, modalidad, prebasica, basica, media, primero, segundo, tercero, cuarto, quinto, sexto, septimo, octavo, noveno, decimo, onceavo, doceavo, id])
        return rows[0]
    } catch (error) {
        throw error;
    }
