...
export const postUserC = async (req, res) => {
    try {
        const { nombre, usuario, cecap, correo, idrol, estado, creadopor } = req.body
        console.log(req.body);

        const users = await postUserM(nombre, usuario, cecap, correo, idrol, estado, creadopor)
        //res.json(users)
...
export const updateUserC = async (req, res) => {
    ...
    try {
        const { id } = req.params;
        const { nombre, correo, idrol, estado, modificadopor, usuario } = req.body

        const users = await updateUserM(nombre, correo, idrol, estado, modificadopor, usuario, id)
