...
const Formacion = () => {
    ...
    const handleChange = (event) => {
        ...
        let sanitizedValue = type === "checkbox" ? checked : value === null ? "" : value;
        ...
        setFormData((prevData) => {
            ...
            if (name === "fechainicio" || name === "fechafinal") {
                ...
                newData[name] = isValidDate ? new Date(sanitizedValue).toISOString().split("T")[0] : "";
            ...
            if (name === "minutos") {
                setErrorM(Number(sanitizedValue) > 59 ? "Solo se admiten minutos hasta 59." : "");
            }
                    ...
                    <Grid container spacing={5} mt={2}>
                        <Grid size={{ xs: 12, md: 6 }}>
                            ...
                            <TextField
                                ...
                                helperText={fieldErrors.formacion ? "Este campo es obligatorio" : ""}
                        ...
                        {(formData.modalidad === "Virtual" || formData.modalidad === "Bimodal") && (
                            <Grid size={{ xs: 12, md: 6 }}>
                        ...
                        <Grid size={{ xs: 12, md: 6 }}>
                            ...
                            <TextField
                                fullWidth
                                type="text" // No uses "number" para evitar validaciones nativas inconsistentes
                                ...
                                inputProps={{
                                    ...
                                    pattern: "[0-9]*",   // Ayuda a algunos navegadores
                                }}
                            />
                        </Grid>
