    ...
    try {
      ...
      if (response.data && response.data.length > 0) {
        if (response.data.length === 1) {
          ...
          console.log("Mostrando modal de selección con", response.data.length, "registros");
        }
      }
    } catch (error) {
          ...
          <Paper sx={{ padding: 5, margin: 2, width: "80%" }} elevation={3}>
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12, md: 12 }}>
                ...
                <FormControl error={fieldErrors.sexo}>
                  ...
                  <RadioGroup
                    ...
                    name="sexo"
                    value={formData.sexo}
                    onChange={(e) => !camposBloqueados.sexo && setFormData({ ...formData, sexo: e.target.value })}
                  >
                    <FormControlLabel
                      value="Femenino"
                      control={<Radio disabled={camposBloqueados.sexo} />}
                      label="Mujer"
                      disabled={camposBloqueados.sexo}
                    />
                    <FormControlLabel
                      value="Masculino"
                      control={<Radio disabled={camposBloqueados.sexo} />}
              ...
              <Grid size={{ xs: 12, md: 12 }}>
                ...
                <FormControl fullWidth disabled={camposBloqueados.gradoacademicodocente}>
                  <Select
                    fullWidth
              ...
              <Grid size={{ xs: 12, md: 12 }}>
                ...
                <FormControl disabled={camposBloqueados.deptoresidencia} fullWidth error={fieldErrors.deptoresidencia}>
                  <Select
              ...
              <Grid size={{ xs: 12, md: 12 }}>
                ...
                <FormControl disabled={camposBloqueados.municipioresidencia} fullWidth error={fieldErrors.municipioresidencia}>
                  <Select
              ...
              <Grid size={{ xs: 12, md: 12 }}>
                ...
                <FormControl fullWidth disabled={camposBloqueados.aldearesidencia}>
                  <Select
            ...
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12, md: 12 }}>
                ...
                <FormControl fullWidth disabled={camposBloqueados.idnivelesacademicos} error={fieldErrors.idnivelesacademicos}>
                  <Select
              ...
              <Grid size={{ xs: 12, md: 12 }}>
                ...
                <FormControl fullWidth disabled={camposBloqueados.idgradosacademicos}>
                  <Select
              ...
              <Grid size={{ xs: 12, md: 12 }}>
                <FormControl fullWidth>
                  ...
                  <RadioGroup
                    ...
                    onChange={(e) => !camposBloqueados.tipoadministracion && setFormData({ ...formData, tipoadministracion: e.target.value })}
                  >
                    <FormControlLabel
                      value="Gubernamental"
                      control={<Radio />}
              ...
              <Grid size={{ xs: 12, md: 12 }}>
                ...
                <FormControl disabled={camposBloqueados.zona} fullWidth error={fieldErrors.zona}>
                  <Select
                    name="zona"
                    value={formData.zona}
                    onChange={handleChange}
              ...
              <Grid size={{ xs: 12, md: 12 }}>
                ...
                <FormControl fullWidth disabled={camposBloqueados.departamentoced} error={fieldErrors.departamentoced}>
                  <Select
              ...
              <Grid size={{ xs: 12, md: 12 }}>
                ...
                <FormControl fullWidth disabled={camposBloqueados.municipioced} error={fieldErrors.municipioced}>
                  <Select
                    id="municipioced"
                    name="municipioced"
            ...
            >
              ...
              >
                <Typography id="seleccion-docente-title" variant="h6" component="h2" sx={{ mb: 2 }}>
                ...
                <List>
                  {docentesEncontrados.map((docente, index) => (
                    ...
                    >
                      <ListItemText
                        primary={`${docente.nombre || 'Sin nombre'} - ${docente.centroeducativo || 'Sin centro educativo'}`}
                        secondary={
                          <>
